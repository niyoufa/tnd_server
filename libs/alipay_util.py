...
from renren.app import get_options
import types
...
class Alipay(object):
    ...
    def  __init__(self, out_trade_no, subject, body, total_fee,company='renren'):
        # unique value, max=64
...
#     params['return_url'] = '"m.alipay.com"'
#     params['notify_url'] = '"https://www.renren.com/api/notify/alipay"'
#     params['_input_charset'] = '"utf-8"'
#     params['it_b_pay'] = '"30m"'
#
#     # 从订单数据中动态获取到的必填参数
